...
if(isset($_POST['adauga'])){
    ...
    if(isset($_POST['prett'])){
        $_SESSION['prett']=$_POST['prett'];
    }
    ...
    if (!preg_match($pattern, $telefon)) {
        header("Location: adaugaComanda.php?error=Telefon invalid");
        exit();
    }
    if(preg_match("/([%^@\$#\*]+)/", $oras))
    {
    ...
    $uid = $_SESSION['uid'];
    $sql = "INSERT INTO comenzi(idUtilizator, modelID, montare, tipMontare, modelStalpi, inaltime, numarMetri, transport, nume, telefon, oras, dataLimita, pret) VALUES($uid, $modelID, $mont, '$tipMontare', '$modelStalpi', '$inaltime', $numarMetri, $trans, '$nume', '$telefon', '$oras', '$dataLimita', $pret)";
        ...
        <div class="com">
            ...
            <div class="rand">
                ...
                <select class="inaltime" id="inaltime" name="inaltime">
                    ...
                    <option value="2.75m" <?php if(isset($_SESSION['inaltime']) && $_SESSION['inaltime'] == '2.75m') echo "selected";?>>2.75m</option>
            ...
            <div class="rand">
                ...
                <input type="text" class="numarMetri" id="pret" name="prett" placeholder="Pret" style="text-align: center;" value="<?php
                    if (isset($_SESSION['prett'])) {
                        echo $_SESSION['prett'];
                    }
                    ?>"><br>
            </div>
